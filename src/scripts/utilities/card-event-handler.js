...
import getDataForModalBody from './generate-modal-body';
import modalBodyComponent from '../view/templates/modal-body';
...
class CardEventHandler {
  ...
  _renderModalBodyComponent(dataRestaurant) {
    this._modalBody.innerHTML = modalBodyComponent.template(dataRestaurant);
    modalBodyComponent.initButtonHandlerModalBody(dataRestaurant);
